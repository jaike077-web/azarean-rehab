...
**main HEAD = `0186817`** (merge ARC-CYCLE поверх audio-merge `a9ea058`), **SW v22**. Две большие фичи влиты в прод подряд из двух параллельных сессий: **Custom Audio** (`a9ea058`, ветка `feature/custom-audio-upload`) + **ARC-CYCLE микроцикл** (`0186817`, ветка `feature/arc-cycle-microcycle`). Метрики на merge: backend **48 suite / 876 tests**, frontend **50 suite / 610 tests**, lint:modals clean (130).
