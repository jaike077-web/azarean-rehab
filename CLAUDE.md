...
- **Метрики:** backend **1164**, frontend 758. Все критики обкатаны вживую Vadim. ⏭️ **СЛЕДУЮЩЕЕ: мультивыбор `body_region`** (скаляр→TEXT[], присед=колено+ТБС). Точка входа: [[project-isai-integration]].
