...
router.post('/structure', authenticateToken, async (req, res) => {
  try {
    ...
    return res.json({ data: { fields: out.fields, warnings: out.warnings, review: out.review || null, fixed: Boolean(out.fixed), sanity: out.sanity || null, completeness: out.completeness || null, consistency: out.consistency || null } });
  } catch (error) {
