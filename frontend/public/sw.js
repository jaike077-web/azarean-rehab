...
// v24 (2026-06-01) — ARC-CYCLE визуал D2: секции «Упражнения» (гимнастика/тренировка)
// рендерятся hero-карточками с градиентом + крупной кнопкой «Начать» (как legacy-hero),
// вместо плоских карточек. + block_complex_ids: будущие дни ротации (День Б/В) больше
// не протекают в секцию «Другие комплексы». Новый JS-бандл (экран пациента).
