      ...
      {showDisclaimer && (
        <div className="pd-disclaimer">
          <div className="pd-disclaimer-content">
            ...
            <p className="pd-disclaimer-subtitle">Ваш персональный помощник по восстановлению</p>
            ...
            <div className="pd-disclaimer-card">
              ...
              <p className="pd-disclaimer-card-text">
                Данное приложение предназначено для информационной поддержки процесса восстановления и не заменяет консультацию
            ...
            <div className="pd-disclaimer-card">
              ...
              <p className="pd-disclaimer-card-text">
                Мы обрабатываем ваши персональные данные в соответствии с требованиями ФЗ-152 «О персональных данных».
                Данные передаются по защищённому каналу и используются исключительно для обеспечения процесса
                восстановления. Доступ к ним ограничен вами и вашим куратором. Продолжая использование приложения, вы
