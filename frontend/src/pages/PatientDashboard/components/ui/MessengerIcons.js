...
// Brand-glyphs мессенджеров. Telegram / WhatsApp / MAX — единственное место
// в проекте, где допустимы inline-SVG в UI (lucide не содержит этих brand-icons).
// Все остальные иконки в патиент-дашборде должны идти через lucide-react.

export const IcTelegram = ({ size = 20, color = 'currentColor' }) => (
...
export const IcWhatsApp = ({ size = 20, color = 'currentColor' }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill={color} aria-hidden="true">
...
export const IcMax = ({ size = 20, color = 'currentColor' }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill={color} aria-hidden="true">
...
export const MESSENGERS = {
  ...
  whatsapp: {
    name: 'WhatsApp',
    short: 'WA',
    color: 'var(--pd-color-wa)',
    url: 'https://wa.me/79089049130',
  },
  max: {
    name: 'MAX',
    short: 'MAX',
    color: 'var(--pd-color-max)',
    url: 'https://max.ru/u/f9LHodD0cOI4hg2uUbj3KvRrSd4aLawyoE0EQx969NKJOXeA1Selj8x0qDc',
  },
};

export const MESSENGER_KEYS = Object.keys(MESSENGERS);
